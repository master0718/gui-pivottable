...
export class ShoppingListSearchService extends HttpService {

	private static classInstance?: ShoppingListSearchService;
	...
	public static getInstance(token?: string) {
		if (!this.classInstance) {
			this.classInstance = new ShoppingListSearchService(token);
		}
