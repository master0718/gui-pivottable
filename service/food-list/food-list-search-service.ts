...
export class FoodListSearchService extends HttpService {

	private static classInstance?: FoodListSearchService;
	...
	public static getInstance(token?: string) {
		if (!this.classInstance) {
			this.classInstance = new FoodListSearchService(token);
		}
