...
export class DayMealsSearchService extends HttpService {

    private static classInstance?: DayMealsSearchService;
    ...
    public static getInstance(token?: string) {
        if (!this.classInstance) {
            this.classInstance = new DayMealsSearchService(token);
        }
