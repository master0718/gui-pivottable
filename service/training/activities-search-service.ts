...
export class ActivitiesSearchService extends HttpService {

	private static classInstance?: ActivitiesSearchService;
	...
	public static getInstance(token?: string) {
		if (!this.classInstance) {
			this.classInstance = new ActivitiesSearchService(token);
		}
