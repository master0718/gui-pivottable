...
export class ManageMacrosSearchService extends HttpService {

	private static classInstance?: ManageMacrosSearchService;
	...
	public static getInstance(token?: string) {
		if (!this.classInstance) {
			this.classInstance = new ManageMacrosSearchService(token);
		}
