...
interface ISupplementTableTabViewProps {}

const SupplementTableTabView: NextPage<ISupplementTableTabViewProps> = ({}) => {
  ...
  const mesoCycleItems = getTabItemsToShow(
    supplementListSearchForm.mesoCycleField.items,
    defaultTabCountToShow
  );
  const microCycleItems = getTabItemsToShow(
    supplementListSearchForm.microCycleField.items,
    defaultTabCountToShow
  );
...
SupplementTableTabView.displayName = "SupplementTableTabView";
export { SupplementTableTabView };
