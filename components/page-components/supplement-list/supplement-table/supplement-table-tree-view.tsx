...
interface ISupplementTableTreeViewProps {
  viewMode: string;
}

const SupplementTableTreeView: NextPage<ISupplementTableTreeViewProps> = ({
  viewMode,
}) => {
...
SupplementTableTreeView.displayName = "SupplementTableTreeView";
export { SupplementTableTreeView };
