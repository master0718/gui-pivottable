...
interface IDailyNutritionFactsTargetProps {
    viewMode: string
}

const DailyNutritionFactsTarget: NextPage<IDailyNutritionFactsTargetProps> = ({
    viewMode
}) => {
    return (
        <div className={`flex flex-col ${viewMode === 'scroll' ? "w-[400px]" : ""} gap-1`}>
            ...
            <Card className="rounded-e-none">
                <CardContent className="p-0">
                    <div className="flex flex-col">
                        <div className="border-b border-dotted pl-1 h-6">
                            <h1 className="text-sm font-bold">Nutrition Facts - Daily Target</h1>
                        </div>
...
DailyNutritionFactsTarget.displayName = "DailyNutritionFactsTarget";

export { DailyNutritionFactsTarget };