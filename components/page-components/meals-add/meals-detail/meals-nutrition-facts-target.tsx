...
interface IMealsNutritionFactsTargetProps {
    viewMode: string;
}

const MealsNutritionFactsTarget: NextPage<IMealsNutritionFactsTargetProps> = ({
    viewMode
}) => {
    return (
                ...
                <CardContent className="p-0">
                    <div className="flex flex-col">
                        <div className="border-b border-dotted pl-1 h-6">
                            <h1 className="text-sm font-bold">Nutrition Facts - Meal Target</h1>
                        </div>
...
MealsNutritionFactsTarget.displayName = "MealsNutritionFactsTarget";

export { MealsNutritionFactsTarget };