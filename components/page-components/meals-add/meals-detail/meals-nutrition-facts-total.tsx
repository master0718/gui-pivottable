...
interface IMealsNutritionFactsTotalProps {
    viewMode: string;
}

const MealsNutritionFactsTotal: NextPage<IMealsNutritionFactsTotalProps> = ({
    viewMode
}) => {
    return (
...
MealsNutritionFactsTotal.displayName = "MealsNutritionFactsTotal";

export { MealsNutritionFactsTotal };