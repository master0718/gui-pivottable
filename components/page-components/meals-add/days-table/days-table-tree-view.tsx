...
const DaysTableTreeView: NextPage<IDaysTableTreeViewProps> = ({
    viewMode
}) => {
    ...
    return (
        <div className="w-full">
            <ScrollArea className={`h-[600px] ${viewMode === 'scroll' ? "w-[600px]" : ""} rounded-md border`}>
                    ...
                    {treeData.map((mesoCycle, index) => (
                        <div key={`mesoCycle-${index}`}>
                            <div className="flex items-center">
                                ...
                                <div className="flex-1 text-center border-b border-l h-8 p-1">
                                </div>
                                <div className="flex-1 text-center border-b border-l h-8 p-1">
                                </div>
                                <div className="flex-1 text-center border-b border-l h-8 p-1">
                            ...
                            {mesoCycle.microCycles.map((microCycle, microIndex) => (
                                <div key={`microCycle-${microIndex}`}>
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex-1 text-center border-l h-8 p-1">
                                        </div>
                                        <div className={`flex-1 text-center border-b border-l h-8 p-1`}>
                                    ...
                                    {microCycle.days.map((day, dayIndex) => (
                                        <div key={`day-${dayIndex}`}>
                                            <div className="flex items-center">
                                                ...
                                                <div className={`flex-1 text-center h-8 border-l p-1 ${dayIndex === microCycle.days.length - 1 && microIndex === mesoCycle.microCycles.length - 1 ? "border-b" : ''}`}>
                                                </div>
                                                <div className={`flex-1 text-center h-8 border-l p-1 ${dayIndex === microCycle.days.length - 1 ? "border-b" : ''}`}>
                                                </div>
