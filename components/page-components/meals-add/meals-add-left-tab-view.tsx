...
interface IMealsAddTopLeftViewProps {

}

const MealsAddLeftTabView: NextPage<{ props: IMealsAddTopLeftViewProps, module: string }> = ({
    props,
    module
}) => {
    ...
    return (
        <div className="flex w-full">
            <div className="flex-none w-32 flex flex-col gap-4">
                <Button variant="outline" className={`rounded-e-none border-r-0 ${tabState === "search" ? "bg-[hsl(var(--accent))]" : ""}`} onClick={() => setTabState("search")}>Search</Button>
                <Button variant="outline" className={`rounded-e-none border-r-0 ${tabState === "add" ? "bg-[hsl(var(--accent))]" : ""}`} onClick={() => setTabState("add")}>Add Meals</Button>
            </div>
                        ...
                        <div className="grow flex flex-col">
                            <Tabs defaultValue="tab-view" className="">
                                ...
                                <TabsContent value="tree-view">
                                    <DaysTableTreeView viewMode={"left"} />
                                </TabsContent>
                            </Tabs>
...
MealsAddLeftTabView.displayName = "MealsAddLeftTabView";
export { MealsAddLeftTabView };