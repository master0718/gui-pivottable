...
interface IShoppingTableTreeViewProps {
  viewMode: string;
}

const ShoppingTableTreeView: NextPage<IShoppingTableTreeViewProps> = ({
  viewMode,
}) => {
...
ShoppingTableTreeView.displayName = "ShoppingTableTreeView";
export { ShoppingTableTreeView };
