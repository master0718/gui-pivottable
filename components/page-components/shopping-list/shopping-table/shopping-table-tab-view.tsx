...
interface IShoppingTableTabViewProps {}

const ShoppingTableTabView: NextPage<IShoppingTableTabViewProps> = ({}) => {
  ...
  const mesoCycleItems = getTabItemsToShow(
    shoppingListSearchForm.mesoCycleField.items,
    defaultTabCountToShow
  );
  const microCycleItems = getTabItemsToShow(
    shoppingListSearchForm.microCycleField.items,
    defaultTabCountToShow
  );
...
ShoppingTableTabView.displayName = "ShoppingTableTabView";
export { ShoppingTableTabView };
