...
import { FoodListSearchForm, SearchItem } from "./types"

const initialState: FoodListSearchForm = {
	mesoCycleField: {
		key: "MESO_CYCLE",
		title: "MesoCycles",
...
export const foodListSearchFormSlice = createSlice({
	name: "foodListSearchForm",
...
// selectors
export const getFoodListSearchForm = (state: RootState) => state.foodListSearchForm

export const { reducer } = foodListSearchFormSlice;