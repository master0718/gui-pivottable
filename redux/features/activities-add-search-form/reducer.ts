...
import { ActivitiesAddSearchForm, SearchItem } from "./types"

const initialState: ActivitiesAddSearchForm = {
    mesoCycleField: {
        key: "MESO_CYCLE",
        title: "MesoCycles",
...
export const activitiesAddSearchFormSlice = createSlice({
    name: "activitiesAddSearchForm",
...
// selectors
export const getActivitiesAddSearchForm = (state: RootState) => state.activitiesAddSearchForm

export const { reducer } = activitiesAddSearchFormSlice;