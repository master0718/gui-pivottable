...
import { MealsAddSearchForm, SearchItem } from "./types"

const initialState: MealsAddSearchForm = {
    mesoCycleField: {
        key: "MESO_CYCLE",
        title: "MesoCycles",
...
export const mealsAddSearchFormSlice = createSlice({
    name: "mealsAddSearchForm",
...
// selectors
export const getMealsAddSearchForm = (state: RootState) => state.mealsAddSearchForm

export const { reducer } = mealsAddSearchFormSlice;