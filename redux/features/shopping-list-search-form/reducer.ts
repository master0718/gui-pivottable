...
import { ShoppingListSearchForm, SearchItem } from "./types"

const initialState: ShoppingListSearchForm = {
	mesoCycleField: {
		key: "MESO_CYCLE",
		title: "MesoCycles",
...
export const shoppingListSearchFormSlice = createSlice({
	name: "shoppingListSearchForm",
...
// selectors
export const getShoppingListSearchForm = (state: RootState) => state.shoppingListSearchForm

export const { reducer } = shoppingListSearchFormSlice;